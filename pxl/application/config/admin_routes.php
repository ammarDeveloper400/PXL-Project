...
///Stores Routes
$route['admin/coaches'] = 'admin/stores/index';
$route['admin/coach-status/(:num)/(:num)'] = 'admin/stores/status/$1/$2';
$route['admin/delete-coach/(:num)'] = 'admin/stores/delete/$1';
$route['admin/provider/view-details/(:num)'] = 'admin/stores/details/$1';
$route['admin/add-coach'] = 'admin/stores/add';
$route['admin/edit-coach/(:num)'] = 'admin/stores/edit/$1';
