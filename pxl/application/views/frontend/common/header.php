	...
	<div id="sidebarMenu" class="mobile">
		<div class="menu_left_pad">
			<div class="menu_cat">
				...
				<a href="<?php echo base_url();?>shop" class="nav_link">Shop</a>
				<a href="https://pxlelite.com/knowledge/" class="nav_link">Knowledge</a>
				<a href="https://pxltennis.com/" class="nav_link">Tennis</a>
				<?php if(isset($_SESSION["PXLLOGIN"])){?>
					<a href="<?php echo base_url();?>dashboard" class="nav_link">My Account</a>
				<?php } ?>
			</div>
			 <?php if(isset($_SESSION["PXLLOGIN"])){?>
				...
				<div class="right_nav">
					<div class="desktop">
						<div class="normal_link">
							...
							<li>
								<a href="<?php echo base_url();?>shop" class="nav_link <?php echo $active_shop==1?'active_link':'';?>">Shop</a>
							</li>
							<li>
								<a style="margin-right: 35px;" href="https://pxlelite.com/knowledge/" class="nav_link">Knowledge</a>
							</li>
							<li>
								<a style="margin-right: 35px;" href="https://pxltennis.com/" class="nav_link">Tennis</a>
							</li>
							<li class="show_sub_menu">
							<a href="<?php echo base_url();?>pxl/plus" class="nav_link bg_color">PXL+ <svg width="29" height="30" viewBox="0 0 29 30" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="sub_menu">
							...
							<a href="<?php echo base_url();?>coaches">Coaches</a>
							<a href="<?php echo base_url();?>events">Affiliates</a>
