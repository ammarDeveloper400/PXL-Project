    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo $url."admin/users";?>">Athletes</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group <?=(form_error('fname') !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="text" name="fname" class="form-control" required data-validation-required-message="This field is required" placeholder="Full Name" value="<?php if(set_value('fname') != ''){ echo set_value('fname');}else echo $prev->fname;?>" >
