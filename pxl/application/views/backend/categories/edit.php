            ...
            <div class="card">
                ...
                <div class="card-body lang_bodieslisting ">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="url" required name="<?php echo $input; ?>" class="form-control form-control-line" placeholder="URL" value="<?php if(set_value($input) != ''){ echo set_value($input);} else{ echo $data->link_external; } ?>">
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <select name="<?php echo $input; ?>" required class="form-control form-control-line">
                                        ...
                                        <option value="1" <?php echo $data->type==1?"SELECTED":"";?>>Events</option>
                                        <option value="2" <?php echo $data->type==2?"SELECTED":"";?>>Affiliate</option>
                                    </select>
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <textarea rows="5" name="<?php echo $input; ?>" class="form-control form-control-line" required><?php echo strip_tags($data->description); ?></textarea>
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        <div class="col-lg-12 col-md-12 nopad">
                            <div class="card">
                                <div class="">
                                    <label>Image</label>
                                    <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="<?php echo $input; ?>" data-default-file="<?php echo base_url();?>resources/uploads/events/<?php echo $data->image;?>" />
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>
                        </div>
