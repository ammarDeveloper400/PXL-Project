    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo $url."admin/sports";?>">Sports</a></li>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Update Sport
                    </h4>
                </div>
                <div class="card-body lang_bodieslisting">
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="<?php echo $input; ?>" class="form-control form-control-line" placeholder="Sport Name" value="<?php if(set_value($input) != ''){ echo set_value($input);} else echo $data->title; ?>" >
