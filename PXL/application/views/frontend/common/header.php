	...
	<div id="sidebarMenu" class="mobile">
		<div class="menu_left_pad">
			<div class="menu_cat">
				...
				<a href="https://shop.pxlelite.com/" class="nav_link" target="_blank">Shop</a>
				...
				<div class="right_nav">
					<div class="desktop">
						<div class="normal_link">
							...
							<li>
								<a target="_blank" href="https://shop.pxlelite.com/" class="nav_link <?php echo $active_shop==1?'active_link':'';?>">Shop</a>
							</li>
							<li>
