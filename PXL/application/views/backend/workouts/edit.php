<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Workout Management</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo $url."admin";?>">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="<?php echo $url."admin/workouts";?>">Workout</a></li>
                <li class="breadcrumb-item active">Edit Workout</li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="text" required name="<?php echo $input; ?>" class="form-control form-control-line" placeholder="Title" value="<?php if(set_value($input) != ''){ echo set_value($input);} else{ echo $data->title_1; } ?>">
                   ...
                   <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="text" required name="<?php echo $input; ?>" class="form-control form-control-line" placeholder="Training" value="<?php if(set_value($input) != ''){ echo set_value($input);} else{ echo $data->title; } ?>">
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="text" required name="<?php echo $input; ?>" class="form-control form-control-line" placeholder="Equipment" value="<?php if(set_value($input) != ''){ echo set_value($input);} else{ echo $data->sub_head; } ?>">
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="text" required name="<?php echo $input; ?>" class="form-control form-control-line" placeholder="Strength" value="<?php if(set_value($input) != ''){ echo set_value($input);} else{ echo $data->strength; } ?>">
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>
                        </div>
