                            ...
                            <tr>
                            	...
                            	<td>
                            		<?php if($store->status == 0){?>
                                       ...
                                       <a title="Click to activate coach profile" href="<?php echo $url.'admin/stores/status/'.$store->id.'/0';?>" >
                                            <button type="button" class="btn btn-primary d-lg-block">Click To Active </button>
                                        </a> 
