                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            ...
                            <div class="ml-auto">
                                <h2 class="counter text-primary"><?php echo $this->db->query("SELECT * FROM users WHERE user_type = 1")->num_rows(); ?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            ...
                            <div class="ml-auto">
                                <h2 class="counter text-purple"><?php echo $this->db->query("SELECT * FROM users  WHERE user_type = 2")->num_rows(); ?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
