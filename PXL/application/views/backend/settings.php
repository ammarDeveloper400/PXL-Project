               ...
               <div class="card-header">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="paypal_username" class="form-control" required data-validation-required-message="This field is required" placeholder="" value="<?php if(set_value('paypal_username') != ''){ echo set_value('paypal_username');}else{ echo $data->paypal_username;}?>"> 
                                <div class="text-danger"><?php echo form_error('paypal_username');?></div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="paypal_password" class="form-control" required data-validation-required-message="This field is required" placeholder="" value="<?php if(set_value('paypal_password') != ''){ echo set_value('paypal_password');}else{ echo $data->paypal_password;}?>"> 
                                <div class="text-danger"><?php echo form_error('paypal_password');?></div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="paypal_signature" class="form-control" required data-validation-required-message="This field is required" placeholder="" value="<?php if(set_value('paypal_signature') != ''){ echo set_value('paypal_signature');}else{ echo $data->paypal_signature;}?>"> 
                                <div class="text-danger"><?php echo form_error('paypal_signature');?></div>
                                </div>
