                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <select name="<?php echo $input; ?>" required class="form-control form-control-line">
                                        ...
                                        <option value="0" <?php echo $data->is_test==1?"SELECTED":"";?>>Testing</option>
                                        <option value="1" <?php echo $data->is_test==0?"SELECTED":"";?>>Shop Product</option>
                                    </select>
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>
                                ...
                                <div class="controls">
                                    <select name="<?php echo $input; ?>" class="form-control form-control-line">
                                        ...
                                        foreach ($countries as $one_country) {
                                            ?>
                                            <option value="<?php echo $one_country; ?>" <?php echo $data->country==$one_country?"SELECTED":"";?>><?php echo $one_country; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        <div class="col-lg-12 col-md-12 nopad">
                            <div class="card">
                                <div class="">
                                    <label>Image</label>
                                    <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="<?php echo $input; ?>" data-default-file="<?php echo base_url();?>resources/uploads/products/<?php echo $data->image;?>" />
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>
                        </div>
